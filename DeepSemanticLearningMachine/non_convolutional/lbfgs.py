...
class LBFGS:
    ...
    def fit(self, X, y, activations, deltas, coef_grads, intercept_grads, layer_units, random_state, coef_init=None,
            intercept_init=None, init_bound=1, fixed_weighted_input=None):
        self.n_iter_ = 0
    ...
    def _fit_inner(self, X, y, activations, deltas, coef_grads, intercept_grads, layer_units):
        ...
        optimal_parameters, self.loss_, d = fmin_l_bfgs_b(x0=packed_coef_inter, func=self._loss_grad_lbfgs,
                                                          maxfun=self.max_iter, iprint=iprint, pgtol=self.tol,
    ...
    def _backprop(self, X, y, activations, deltas, coef_grads, intercept_grads):
        ...
        coef_grads, intercept_grads = self._compute_loss_grad(last, n_samples, activations, deltas, coef_grads,
                                                              intercept_grads)
        ...
        for i in range(self.n_layers_ - 2, 0, -1):
            ...
            coef_grads, intercept_grads = self._compute_loss_grad(i - 1, n_samples, activations, deltas, coef_grads,
                                                                  intercept_grads)
